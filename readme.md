...
* __Notifications__ - out of the box Keel has Slack, Hipchat, Mattermost, Google Chat and standard webhook notifications, more info [here](https://keel.sh/docs/#notifications)
