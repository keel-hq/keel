...
- [~] Create traversable ServiceAccount mount-parent directories in the non-root Keel image to fix the clean-cluster deployability defect proven by root and UID-666 probes.
