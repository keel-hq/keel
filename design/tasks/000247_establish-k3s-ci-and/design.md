...
- `make test` passed in a disposable `golang:1.23.4-alpine` container with cgo/build tools because the sandbox host lacks `make` and a compiler. Focused helpers passed repeatedly; `bash -n`, ShellCheck 0.10.0, and actionlint 1.7.7 passed.
