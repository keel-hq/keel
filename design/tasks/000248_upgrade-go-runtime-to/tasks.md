...
- [x] Synchronize and push the Keel feature branch, then create the concise PR title and description.
- [x] Confirm that no release, image push, deployment, publication, merge commit, or unrelated modernization was performed.
