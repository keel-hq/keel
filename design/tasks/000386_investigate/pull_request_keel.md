...
- `make release-validate` (local k3s harness) is not applicable: the change is pure version-comparison logic and does not affect application startup or the Helm chart, which is the condition AGENTS.md uses to require that validation.
